...
export const TermsOfService = () => {
  return (
    <article className={`mt-16 m-auto w-full ${Style.role}`}>
      <h2 className="text-center w-4/5 m-auto text-3xl py-8">利用規約</h2>
      <section className="bg-white rounded w-4/5 m-auto p-8">
        <div>
          <p>この利用規約（以下，「本規約」といいます。）は，Pythagora maker（以下，「運営」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
        </div>
        <div>
          <h4>第1条（適用）</h4>
          <ol>
        ...
        <div>
          ...
          <ol>
            <li>運営は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーとしての登録を抹消することができるものとします。
              <ol>
